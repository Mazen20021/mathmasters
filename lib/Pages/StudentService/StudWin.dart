...
class Studwin extends StatefulWidget {
  final String email, name;
  const Studwin({required this.email, required this.name, super.key});
  @override
  _Studwin createState() => _Studwin(email: email, name: name);
}

class _Studwin extends State<Studwin> {
  final String email, name;
  _Studwin({required this.email, required this.name});
