...
class SpecialLevelSelection extends StatefulWidget {
  final String level;
  final List<String> pureSubjects;
  final List<String> appliedSubjects;
  final bool hasApplied;
  final String Class;
  SpecialLevelSelection(
...
class SubjectsPage extends State<SpecialLevelSelection> {
  final String level;
  final List<String> pureSubjects;
  final List<String> appliedSubjects;
  final bool hasApplied;
                ...
                children: [
                  Expanded(
                    child: _buildProgramCard(
                      ...
                      if (Class == "FP") {
                        Navigator.pushNamed(context, "/classsub", arguments: {
                          "Class": "FirstPrep",
                          "Name": "Algebra"
                        });
                      } else if (Class == "SP") {
                        Navigator.pushNamed(context, "/classsub",
                            arguments: {"Class": "SecPrep", "Name": "Algebra"});
                      } else if (Class == "TP") {
                        Navigator.pushNamed(context, "/classsub", arguments: {
                          "Class": "ThirdPrep",
                          "Name": "Algebra"
                        ...
                        Navigator.pushNamed(context, "/classsub",
                            arguments: {"Class": "SecSec", "Name": "Algebra"});
                    }),
                  ),
